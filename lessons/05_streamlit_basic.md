...
> **이번 시간의 도착점:** 파일 입력·실행 버튼·처리 상태·결과 화면이 연결된 최소 웹앱을 만들고, 준비 결과가 실제 처리 결과가 아님을 화면에서 구분합니다.

[5교시 Colab 실습 열기](https://colab.research.google.com/github/leecks1119/document_ai_lecture/blob/master/colab/05_streamlit_basic.ipynb)
...
기본 완성 코드의 `공개 영수증 결과 확인` 버튼을 누르면 다음 내용이 나타납니다.
